    ...
    return (
      <div className="h-96 relative w-full overflow-hidden bg-slate-900 flex flex-col items-center justify-center rounded-lg">
        ...
        <p className="text-center mt-2 text-neutral-300 relative z-20 px-60">
          ...
          non-governmental organizations. Our platform empowers NGOs to
          streamline their operations, from member management to event planning,
          allowing them to focus more on their mission and less on
          administrative tasks. With features like Excel import,
          multi-organization support, and intuitive user interfaces, NeatNGO is
          the all-in-one solution for modern NGOs looking to maximize their
          impact.
        </p>
      </div>
    );
